...
namespace TireTak
{
    public partial class FormWheelSizeAdd : Form
    {
    ...
    (
        ...
        #endregion  
        public FormWheelSizeAdd()
        {
            InitializeComponent();
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 20, 20));
        }
        SqlConnection conn = new SqlConnection(MainClass.connString);
        private void FormWheelSizeAdd_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                string wheelSize = txtbxWheelSizeAdd.Text;
                conn.Open();
                string insertQuery = "INSERT INTO wheel_size (wheel_size) VALUES (@wheelSize)";
