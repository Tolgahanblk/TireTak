...
namespace TireTak
{
    ...
    public partial class FormTireModelAdd : Form
    {
    ...
    (
        ...
        #endregion  
        public FormTireModelAdd()
        {
            InitializeComponent();
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 20, 20));
        }
        SqlConnection conn = new SqlConnection(MainClass.connString);
        private void FormTireModelAdd_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                string tireModel = txtbxTireModelAdd.Text;
                conn.Open();
                string insertQuery = "INSERT INTO tire_model (tire_model) VALUES (@tireModel)";
