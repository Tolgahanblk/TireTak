...
namespace TireTak
{
    public partial class FormTireSizeAdd : Form
    {
    ...
    (
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                string tireSize = txtbxTireSizeAdd.Text;
                conn.Open();
                string insertQuery = "INSERT INTO Tire_size (tire_size) VALUES (@tireSize)";
