...
namespace TireTak
{
    public partial class FormWheelRAdd : Form
    {
    ...
    (
        ...
        private void FormWheelRAdd_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                string wheelR = txtbxWheelRAdd.Text;
                conn.Open();
                string insertQuery = "INSERT INTO wheel_r (wheel_r) VALUES (@wheelR)";
