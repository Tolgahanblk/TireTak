...
namespace TireTak
{
    public partial class FormTireBrandAdd : Form
    {
    ...
    (
        ...
        #endregion  
        public FormTireBrandAdd()
        {
            InitializeComponent();
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 20, 20));
        }
        SqlConnection conn = new SqlConnection(MainClass.connString);
        private void FormTireBrandAdd_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                string tireBrand = txtbxTireBrandAdd.Text;
                conn.Open();
                string insertQuery = "INSERT INTO Tires_brand (tire_brand) VALUES (@tireBrand)";
        ...
        private void txtbxTireBrandAdd_TextChanged(object sender, EventArgs e)
        {
